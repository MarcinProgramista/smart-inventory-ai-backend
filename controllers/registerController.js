...
export const register = async (req, res) => {
  ...
  try {
    ...
    // 3️⃣ Insert default suppliers
    await db.query(
      `
    INSERT INTO suppliers (user_id, name, contact, phone, email, address)
    SELECT $1, name, contact, phone, email, address
    FROM supplier_default
    `,
      [userId]
    );
